...
const CHARACTERS = [
  {
    ...
    trait: "高齢だが、医療の知識がある。",
    introExtra: "ケガや体調不良への応急処置ができる、漂流生活での頼れる存在。しかし、食料を得られなければ意識を失うほど衰弱してしまう危険もある。",
    backstory: "定期船で、本土の病院に通院する途中だった。",
  ...
  },
  {
    ...
    introExtra: "長年海で暮らしてきた経験があり、荒れた無人島でも何かと頼りにされそうです。しかし、食料を得られなければ回復が遅れ、動けなくなってしまう危険もある。",
    backstory: "嵐の前兆に気づいていた、ベテラン漁師。たまたま同じ船に乗り合わせていた。",
  ...
  },
  {
    ...
    introExtra: "出産が近く、栄養状態が母子二人の命に直結する状況にある。そのため、食料を得られなければ、体調が急変してしまう危険もある。",
    backstory: "出産のため、本土の病院へ向かう途中だった。",
  ...
  },
  {
    ...
    introExtra: "保護者がおらず、大人のサポートなしでは生き延びるのが難しい状況にある。そのため、食料を得られなければ、衰弱して動けなくなってしまう危険もある。",
    backstory: "島の祖父母の家に遊びに来ていて、一人で帰る途中だった。",
